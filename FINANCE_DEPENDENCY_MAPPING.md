...
• عدد الملفات التي تستخدم FinanceService مباشرة: 4 ملفات إنتاجية + 2 ملفات اختبار (مضافة في الفحص النهائي)
• عدد الملفات التي تستخدم FinanceService عبر ServiceFinancialEngine: 6 ملفات إنتاجية + 1 ملف اختبار (_test_cash_fix.php)
...
==============================================
 (ج) ملفات اختبار / سكربتات تستخدم FinanceService (2 ملفات — مضافة من الفحص النهائي)
==============================================

11. _test_mini.php                                           [سطر 12, 34]
    الدوال المستدعاة:
      - new FinanceService()                                [سطر 34]
      - resolvePartyAccountId()  (عبر ReflectionMethod)    [سطر 35]
    الاستخدام: سكربت اختبار سريع لفحص إنشاء حساب مالي للعميل
               تلقائياً (اختبار الإصلاح).

12. _test_cash_fix.php                                       [سطر 7, 60, 77, 101, 139]
    الدوال المستدعاة:
      - new FinanceService()                                [سطر 60]
      - getOrCreateDefaultCashCustomer()                    [سطر 61]
      - resolvePartyAccountId() (عبر ReflectionObject)      [سطر 74-77]
      - processServiceOperation()                           [سطر 101, 139]
    الاستخدام: سكربت اختبار شامل لإصلاح مبيعات النقد بدون عميل.
               ⚠️ يحتوي كذلك على خطوات تعديل قاعدة البيانات (ADD COLUMN) مباشرةً
                  في الجزء العلوي — وهو سكربت تطويري محلي لا يُستخدم في الإنتاج.
