...
function adminPages(): array
{
    return [
        ...
        'otp_settings' => ['title' => 'إعدادات OTP', 'page' => 'otp_settings', 'permissions' => ['manage_settings'], 'any' => false],
        'languages' => ['title' => 'إدارة اللغات', 'page' => 'languages', 'permissions' => ['languages.view'], 'any' => false],
        'translations' => ['title' => 'الترجمة المركزية', 'page' => 'translations', 'permissions' => ['translations.view'], 'any' => false],
        'banks' => ['title' => 'البنوك', 'page' => 'banks', 'permissions' => ['manage_settings'], 'any' => false],
...
{
    global $database, $languageService;
    ...
    $languageContext = $GLOBALS['languageService']->context();
    ...
    $adminPageTitle = $languageService->translate((string) $page['title'], (string) $page['title']);
    $platformTitle = (string) ($siteSettings['site_name'] ?? $siteSettings['site_name_ar'] ?? 'منصة حجوزات الباصات');
    ?><!doctype html><html lang="<?= Security::escape($languageCode) ?>" dir="<?= Security::escape($languageDirection) ?>"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="csrf-token" content="<?= Security::escape(Security::csrfToken()) ?>"><title><?= Security::escape($adminPageTitle) ?> | <?= Security::escape($platformTitle) ?></title><?= $iconHref !== '' ? '<link rel="icon" type="image/png" href="' . $iconHref . '">' : '' ?><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.googleapis.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Tajawal:wght@400;500;700;800;900&display=swap" rel="stylesheet"><link rel="stylesheet" href="<?= Security::escape($bootstrapCss) ?>"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css"><link rel="stylesheet" href="assets.php?asset=main-routes-css&v=20260825-13"><link rel="stylesheet" href="../assets/css/app.css?v=20260901-16"></head><body class="dashboard-page" data-api-base="../api/v1" data-language-code="<?= Security::escape($languageCode) ?>" data-language-direction="<?= Security::escape($languageDirection) ?>"><main id="app" data-role="admin" data-admin-page="<?= Security::escape($page['page']) ?>"></main><script src="https://cdn.jsdelivr.net/npm/qrcode@1.5.3/build/qrcode.min.js" defer></script><script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.4/dist/chart.umd.min.js" defer></script><script src="../assets/js/i18n.js?v=20260901-13" defer></script><script src="../assets/js/app.js?v=20260901-15" defer></script><?= $loadSubroutesModule ? '<script src="assets.php?asset=subroutes-js&v=20260825-10" defer></script>' : '' ?><script src="assets.php?asset=stations-js&v=20260827-03" defer></script><script src="assets.php?asset=main-routes-js&v=20260825-16" defer></script></body></html><?php
}
