...
CREATE TABLE IF NOT EXISTS trips (
  ...
  agent_commission_value DECIMAL(12,4) NULL,
...
CREATE TABLE IF NOT EXISTS agents (
  ...
  company_id BIGINT UNSIGNED NOT NULL,
  user_id BIGINT UNSIGNED NOT NULL UNIQUE,
  agent_code CHAR(10) NULL UNIQUE,
  country_id BIGINT UNSIGNED NOT NULL,
  latitude DECIMAL(10,7) NULL,
  longitude DECIMAL(10,7) NULL,
...
CREATE TABLE IF NOT EXISTS company_financial_settings (
  ...
  settlement_cycle_days SMALLINT UNSIGNED NOT NULL DEFAULT 7,
...
CREATE TABLE IF NOT EXISTS payments (
  ...
  CONSTRAINT fk_payments_bank FOREIGN KEY (bank_id) REFERENCES banks(id) ON DELETE SET NULL,
...
INSERT IGNORE INTO trip_display_settings (id, show_company_cost, show_available_seats, show_bookings_button, show_agent_commission, show_price_change_badge, allow_agent_payment, allow_company_payment, allow_bank_transfer)
VALUES (1, 0, 1, 1, 1, 0, 1, 1, 1);


-- Rihla OTP verification (additive; no existing data is removed)
...
-- Keep the payment environment immutable for refunds and reconciliation.
ALTER TABLE payments
